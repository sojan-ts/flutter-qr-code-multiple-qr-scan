...
class _QRViewExampleState extends State<QRViewExample> {
  ...
  List<String> scannedDataList = []; // Store scanned data
  ...
  void _showScannedDataList(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ScannedDataListPage(scannedDataList),
      ),
    );
  }
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      print(scanData.code);
      if (!scannedDataList.contains(scanData.code)) {
        setState(() {
          scannedDataList.add(scanData.code ?? 'unknown');
          result = scanData;
        });
      }
    });
